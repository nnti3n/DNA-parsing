...
def main(argv):
	...
	all_grams = []
	temp_dna = []
	chars = ["subtype: A1", "subtype: A2", "subtype: B2", "subtype: C1", "subtype: C2",
	"subtype: F1", "subtype: D1", "subtype: F1", "genotype: A1", "genotype: A2",
	"genotype: B2", "genotype: C1", "genotype: C2", "genotype: D1", "genotype: F1", "genotype A1;", "genotype A2;", 
	"genotype B2;", "genotype C1;", "genotype C2;",
	"genotype D1;", "genotype F1;"]
